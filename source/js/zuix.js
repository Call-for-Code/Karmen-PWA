    ...
    return (function () {
        ...
        5: [function (_dereq_, module, exports) {
            ...
            function addEventHandler(el, path, handler, options) {
                ...
                if (!found) {
                    _zuix_events_mapping.push({
                        element: el,
                        path: path,
                        handler: handler,
                        opgions: options
                    });
                    el.addEventListener(path, routeEvent, supportsPassive && (options == null || options.passive !== false) ? {
                        passive: true
                    } : false);
                }
            }
            ...
            ZxQuery.prototype.trigger = function (eventPath, eventData) {
                ...
                if (window.CustomEvent) {
                    event = new CustomEvent(eventPath, {
                        detail: eventData
                    });
                } else {
        ...
        11: [function (_dereq_, module, exports) {
            ...
            const OptionAttributes = Object.freeze({
                ...
                dataBindTo: 'data-bind-to',
                dataUiComponent: 'data-ui-component',
                dataUiContext: 'data-ui-context',
                dataUiField: 'data-ui-field',
                dataUiInclude: 'data-ui-include',
                dataUiLazyload: 'data-ui-lazyload',
                dataUiLoad: 'data-ui-load',
                dataUiLoaded: 'data-ui-loaded',
                dataUiOptions: 'data-ui-options',
                dataUiPriority: 'data-ui-priority',
                dataUiView: 'data-ui-view',
                zuixLoaded: 'zuix-loaded'
            });
        ...
        12: [function (_dereq_, module, exports) {
            ...
            function load(componentId, options) {
                ...
                if (resourceLoadTask[componentId] == null) {
                    ...
                    _pendingResourceTask[componentId].push({
                        c: ctx,
                        o: options
                    });
                }
